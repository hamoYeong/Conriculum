...
@MainActor
struct V1ChapterThreeFullContentTests {
    @Test
    func allNineLessonsMatchTheObsidianLearningRoute() throws {
        ...
        #expect(chapter.allPages.allSatisfy(V1LearningContentAssembly.isAssembled))
    }
    ...
    private static let learnerWorkTags: Set<V1LearningSectionTag> = [
        .cardSorting,
        .matching,
        .choiceWithReason,
        .fillInBlank,
    ...
    private func chapterThree() throws -> V1Chapter {
