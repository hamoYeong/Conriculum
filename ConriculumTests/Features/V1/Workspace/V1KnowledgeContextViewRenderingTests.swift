...
@MainActor
struct V1KnowledgeContextViewRenderingTests {
    @Test
    func emptyAndPersonalizedSnapshotsRenderAtSidebarWidth() throws {
        ...
        let fixtures: [(
            name: String,
            snapshot: V1KnowledgeContextSnapshot,
        ...
        for fixture in fixtures {
            let state = V1KnowledgeContextFeature.State(
                chapterID: chapter.id,
                currentPageID: pageID,
                snapshot: fixture.snapshot,
                v1PendingPersonalizationReviews: fixture.pendingReviews
            )
            let view = V1KnowledgeContextView(
