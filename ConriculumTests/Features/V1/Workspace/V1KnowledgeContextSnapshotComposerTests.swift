...
@MainActor
struct V1KnowledgeContextSnapshotComposerTests {
    @Test
        ...
        throws
    {
        ...
        let pageFive = try V1KnowledgeContextSnapshotComposer().compose(
            chapter: chapter,
            catalog: catalog,
        ...
        let overview = try V1KnowledgeContextSnapshotComposer().compose(
            chapter: chapter,
            catalog: catalog,
        ...
        throws
    {
        ...
        let pageSeven = try V1KnowledgeContextSnapshotComposer().compose(
            chapter: chapter,
            catalog: catalog,
        ...
        let pageEight = try V1KnowledgeContextSnapshotComposer().compose(
            chapter: chapter,
            catalog: catalog,
        ...
        let pageSix = try V1KnowledgeContextSnapshotComposer().compose(
            chapter: chapter,
            catalog: catalog,
    ...
    func missingPageAndConceptReportStableIdentifiers() throws {
        ...
        #expect(throws: V1KnowledgeContextSnapshotComposerError.missingPage(
            "missing-page"
        )) {
        ...
        let missingConceptPage = V1LearningPage(
            id: "test-page",
            kind: .lesson,
            order: 1,
            title: "테스트",
        ...
        #expect(throws: V1KnowledgeContextSnapshotComposerError.missingConcept(
            "missing-concept"
        )) {
            try V1KnowledgeContextSnapshotComposer().compose(
