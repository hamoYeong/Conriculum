...
@MainActor
@Suite(.serialized)
struct V1ConceptInspectorViewRenderingTests {
    ...
    func revisionRelationAndCandidateStatesRenderAtInspectorWidth(width: Double) throws {
        ...
        for (index, state) in states.enumerated() {
            let view = V1ConceptInspectorView(
    ...
    private func relationEditorState() -> V1ConceptInspectorFeature.State {
    ...
    private func activityCandidateState() -> V1ConceptInspectorFeature.State {
