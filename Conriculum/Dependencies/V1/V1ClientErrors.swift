...
enum V1ContentClientError: Error, Equatable, Sendable {
...
extension V1ContentClientError: LocalizedError {
...
enum V1PersistenceClientError: Error, Equatable, Sendable {
...
extension V1PersistenceClientError: LocalizedError {
    var errorDescription: String? {
        switch self {
        case .loadFailed:
