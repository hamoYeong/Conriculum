...
struct V1KnowledgeConceptNames {
...
struct V1KnowledgeLinkComponent: View {
    let content: V1KnowledgeLinkSectionContent
    ...
    private func knowledgeLink(_ link: V1LearningKnowledgeLink) -> some View {
...
struct V1EnrichmentTaskComponent: View {
    let content: V1EnrichmentTaskContent
    let conceptNames: V1KnowledgeConceptNames
...
struct V1PersonalKnowledgePromotionComponent: View {
    let content: V1PersonalKnowledgePromotionContent
    let activity: V1LearningActivityInput
    let conceptNames: V1KnowledgeConceptNames
    let onAction: (V1PersonalKnowledgeComponentAction) -> Void
        ...
        LearningBlock(
            ...
            TextEditor(
                text: activity.textBinding(
                    for: V1LearningActivityFieldKey.personalExpression,
        ...
        .confirmationDialog(
            ...
            Button("개념 상세에서 최종 확인") {
                ...
                activity.updating(valuesByKey: [
                    V1LearningActivityFieldKey.personalExpression: [expression],
                    V1LearningActivityFieldKey.personalizationTargetConceptID: [
    ...
    private var selectedTargetConceptID: KnowledgeConceptID? {
        let storedValue = activity.value(
            for: V1LearningActivityFieldKey.personalizationTargetConceptID
        )
...
struct V1PersonalKnowledgeRelationComponent: View {
    let content: V1PersonalKnowledgeRelationSectionContent
    let activity: V1LearningActivityInput
    let conceptNames: V1KnowledgeConceptNames
    let onAction: (V1PersonalKnowledgeComponentAction) -> Void
    @State private var isConfirming = false
    ...
    var body: some View {
        LearningBlock(
            ...
            TextEditor(
                text: activity.textBinding(
                    for: V1LearningActivityFieldKey.relationStatement,
            ...
            Button("개념 상세에서 최종 확인") {
                ...
                onAction(.relationConfirmed(
                    ...
                    reason: activity.value(
                        for: V1LearningActivityFieldKey.reason
                    ),
    ...
    private var selectedSourceConceptID: KnowledgeConceptID? {
        selectedConceptID(
            fieldKey: V1LearningActivityFieldKey.relationSourceConceptID,
    ...
    private var selectedTargetConceptID: KnowledgeConceptID? {
        selectedConceptID(
            fieldKey: V1LearningActivityFieldKey.relationTargetConceptID,
...
struct V1KnowledgeChangeSummaryComponent: View {
    let content: V1KnowledgeChangeSummaryContent
