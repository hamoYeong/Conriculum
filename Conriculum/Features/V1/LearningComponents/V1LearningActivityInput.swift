...
enum V1ActivityDraftSaveState: Equatable, Sendable {
    case idle
    case pending
    case saving
    case saved(Date)
...
struct V1LearningActivityInput {
    let activityID: LearningActivityID
    let fields: [V1ActivityResponseField]
    let onFieldsChanged: (
        _ activityID: LearningActivityID,
        _ fields: [V1ActivityResponseField]
    ) -> Void
    let saveState: V1ActivityDraftSaveState
    ...
    init(
        ...
        saveState: V1ActivityDraftSaveState = .idle,
    ...
    func updating(
        ...
        for key in valuesByKey.keys.sorted() {
            ...
            if let index = updatedFields.firstIndex(where: { $0.key == key }) {
                updatedFields[index] = V1ActivityResponseField(
                    key: key,
                    values: values
                )
            } else {
                updatedFields.append(V1ActivityResponseField(
                    key: key,
                    values: values
                ))
            }
...
struct V1ActivityDraftStatusView: View {
...
enum V1LearningActivityFieldKey {
    static let reason = "reason"
    static let response = "response"
    static let compassPrediction = "compass.prediction"
    static let compassConfidence = "compass.confidence"
    static let compassConfidenceReason = "compass.confidenceReason"
    static let reflectionFinalExplanation = "reflection.finalExplanation"
    static let reflectionConfidence = "reflection.confidence"
    static let reflectionConfidenceReason = "reflection.confidenceReason"
    static let reflectionChangedCriterion = "reflection.changedCriterion"
    static let reflectionNextUse = "reflection.nextUse"
    static let semanticChunkSelection = "semanticChunk.selection"
    static let semanticChunkName = "semanticChunk.name"
    static let semanticChunkFlow = "semanticChunk.flow"
    static let semanticChunkBoundary = "semanticChunk.boundary"
    static let semanticChunkChange = "semanticChunk.change"
...
struct V1ActivityCriteriaView: View {
    let title: String
    let criteria: [String]
    let accent: Color
