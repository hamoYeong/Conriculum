...
enum V1HomePreviewFixtures {
    static let empty = V1HomeSnapshot(
        source: .empty,
        stage: .stageOne,
    ...
    static let mock: V1HomeSnapshot = {
        let timestamp = Date(timeIntervalSince1970: 1_725_782_400)
        let counts: [V1LearningEvidenceKind: Int] = [
            .viewed: 3,
            .activityAttempt: 2,
            .assistedSuccess: 1,
        ...
        return V1HomeSnapshot(
            ...
            chapter: V1HomeSnapshot.ChapterCard(
                ...
                lastPage: V1HomeSnapshot.PageSummary(
            ...
            lastActivity: V1HomeSnapshot.ActivitySummary(
            ...
            evidence: V1LearningEvidenceKind.allCases.map { kind in
                V1HomeSnapshot.EvidenceSummary(
                    kind: kind,
