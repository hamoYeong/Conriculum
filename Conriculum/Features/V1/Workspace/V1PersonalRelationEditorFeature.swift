...
struct V1PersonalRelationDraftRequest: Equatable, Sendable {
...
@Reducer
struct V1PersonalRelationEditorFeature {
    @ObservableState
    struct State: Equatable {
        ...
        fileprivate var saveValidationError: V1PersonalRelationValidationError? {
    ...
    var body: some Reducer<State, Action> {
        Reduce { state, action in
            ...
            case .saveButtonTapped:
                ...
                return .run { send in
                    do {
                        try await v1PersonalKnowledgeClient.saveRelation(
                            relation
                        )
                        let relations = try await v1PersonalKnowledgeClient
                ...
                .cancellable(
                    id: "V1PersonalRelationEditorFeature.save",
                    cancelInFlight: true
                )
...
enum V1PersonalRelationValidationError: LocalizedError, Equatable {
    case invalidSource
    case invalidTarget
    case sameConcept
