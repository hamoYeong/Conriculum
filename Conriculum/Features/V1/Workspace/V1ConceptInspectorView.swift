...
struct V1ConceptInspectorView: View {
    let store: StoreOf<V1ConceptInspectorFeature>
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 18) {
                ...
                if let relationStore = store.scope(
                    ...
                    V1PersonalRelationEditorView(store: relationStore)
                    baseKnowledge
                    knowledgeRelations
                } else {
                    modeBar
    ...
    private func personalizationReviewBanner(
        _ review: V1KnowledgePersonalizationReview
    ) -> some View {
        KnowledgeSection(
            title: "활동 응답 후보 · 저장 전",
    ...
    private func exampleEditor(
        _ example: V1ConceptInspectorFeature.State.ExampleDraft
    ) -> some View {
...
struct V1KnowledgeEditorActionLayout<Content: View>: View {
...
private enum ConceptInspectorPreviewData {
    ...
    static let relationEditor: V1ConceptInspectorFeature.State = {
        ...
        let contract = V1KnowledgeContextSnapshot.RelationCreationContract(
        ...
        var state = V1ConceptInspectorFeature.State(
    ...
    static let activityCandidate: V1ConceptInspectorFeature.State = {
        ...
        return V1ConceptInspectorFeature.State(
