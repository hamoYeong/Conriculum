...
@Reducer
struct V1ConceptInspectorFeature {
    @ObservableState
    struct State: Equatable {
        ...
        let relationCreationContract: V1KnowledgeContextSnapshot
            .RelationCreationContract?
        let personalizationReview: V1KnowledgePersonalizationReview?
        ...
        var relationEditor: V1PersonalRelationEditorFeature.State?
        ...
        init(
            ...
            relationCreationContract: V1KnowledgeContextSnapshot
        ...
        fileprivate func newRelationEditorState()
            -> V1PersonalRelationEditorFeature.State?
        {
            ...
            return V1PersonalRelationEditorFeature.State(
                request: V1PersonalRelationDraftRequest(
        ...
        fileprivate var saveValidationError: V1ConceptRevisionValidationError? {
    ...
    enum Action: Equatable {
        ...
        case relationEditor(V1PersonalRelationEditorFeature.Action)
    ...
    var body: some Reducer<State, Action> {
        Reduce { state, action in
            ...
            case let .editRelationButtonTapped(relationID):
                ...
                state.relationEditor = V1PersonalRelationEditorFeature.State(
                    editing: relation,
            ...
            case .saveButtonTapped:
                ...
                return .run { send in
                    do {
                        try await v1PersonalKnowledgeClient.saveRevision(
                            revision
                        )
                        let revisions = try await v1PersonalKnowledgeClient
                ...
                .cancellable(
                    id: "V1ConceptInspectorFeature.saveRevision",
                    cancelInFlight: true
                )
        ...
        .ifLet(\.relationEditor, action: \.relationEditor) {
            V1PersonalRelationEditorFeature()
        }
    }
...
enum V1ConceptRevisionValidationError: LocalizedError, Equatable {
