...
struct V1KnowledgeContextView: View {
    let store: StoreOf<V1KnowledgeContextFeature>
    ...
    private func snapshotContent(
        ...
        let changeCollection = KnowledgeChangeCollectionComposer().compose(
            ...
            pendingReviews: store.v1PendingPersonalizationReviews
        )
        ...
        return VStack(alignment: .leading, spacing: 18) {
            ...
            collapsibleHeader(
                ...
                count: snapshot.changedConcepts.count
                    ...
                    + store.v1PendingPersonalizationReviews.count,
    ...
    private func coreCriterionCard(
        _ item: V1KnowledgeContextSnapshot.ConceptItem
    ) -> some View {
        VStack(alignment: .leading, spacing: 8) {
            sectionLabel(
                title: "지금 쓰는 기준",
...
private enum KnowledgeContextPreviewData {
    ...
    private static func state(
    ...
    ) -> V1KnowledgeContextFeature.State {
        let direct = V1KnowledgeContextSnapshot.ConceptItem(
            concept: value,
        ...
        let nearby = V1KnowledgeContextSnapshot.ConceptItem(
            concept: type,
        ...
        let snapshot = V1KnowledgeContextSnapshot(
        ...
        return V1KnowledgeContextFeature.State(
