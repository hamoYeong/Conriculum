...
enum ChapterCardStatus: Equatable {
    case completed
    case current
    case upcoming
}

struct ChapterStatusResolver {
    ...
    func status(for chapter: LearningChapter) -> ChapterCardStatus {
...
struct HomeStagePager: View {
    ...
    private var stages: [LearningStage] {
    ...
    private func stagePage(_ stage: LearningStage) -> some View {
        ScrollView {
