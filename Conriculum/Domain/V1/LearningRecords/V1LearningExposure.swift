...
enum V1LearningExposure {
    static func historicalPageIDs(chapter: V1Chapter, progress: V1LearningProgress?) -> Set<LearningPageID> {
    ...
    static func directConceptIDs(page: V1LearningPage) -> Set<KnowledgeConceptID> {
